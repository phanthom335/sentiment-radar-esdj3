    """
    Sentiment Radar Esdj3
    =====================
    Lightweight AI-powered tool designed to analyse unstructured data at scale.
    ...
    APP_NAME    = "Sentiment Radar Esdj3"
    APP_VERSION = "1.0.0"
...
return result
    ...
    def build_parser() -> argparse.ArgumentParser:
        p = argparse.ArgumentParser(prog=APP_NAME, description="Lightweight AI-powered tool designed to analyse unstructured data at scale.")
